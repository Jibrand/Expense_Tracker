      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 flex-1 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <h4 className="font-bold text-text-main text-[11px] line-clamp-1 leading-tight mb-0.5">
        ...
        <div className="text-right shrink-0">
          <p className={`font-bold text-[12px] leading-tight ${isIncome ? 'text-secondary' : 'text-danger'}`}>
            {isIncome ? '+' : '-'} {(amount || 0).toLocaleString()}
          </p>
          <p className="text-[8px] text-text-muted mt-1 font-medium">
